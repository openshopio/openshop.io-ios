...
/**
 * `BFCollectionReusableView` is a base collection view header or footer view wrapper
 ...
 */
@interface BFCollectionReusableView : UICollectionReusableView
