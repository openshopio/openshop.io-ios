...
/**
 * `BFOrderShippingParsedResult` customizes `BFParsedResult` for order shipping data model parsing.
 ...
 */
@interface BFOrderShippingParsedResult : BFParsedResult
