//
//  BFProductVariantSize+BFNFiltering.h
//  OpenShop
//
...
/**
 * `BFNFiltering` category of BFProductVariantSize adds ability to be used as the filtering data source item
 ...
 */
@interface BFProductVariantSize (BFNFiltering) <BFNFiltering, BFAPIResponseDataModelMapping>
