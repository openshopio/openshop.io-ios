//
//  BFProductVariantSizeParsedResult.h
//  OpenShop
//
...
/**
 * `BFProductVariantSizeParsedResult` customizes `BFParsedResult` for product variant size parsing.
 ...
 */
@interface BFProductVariantSizeParsedResult : BFParsedResult
